                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="topBreadcrumb">                
                          ...
                          <span class="breadcrumb-item active">Carpet Payment</span>
                        </nav>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <tbody>
                         ...
                         @foreach($payments as $payment)
                              <tr>
                                <td>{{$i++}}</td>
                                <td>@if(!empty($payment->carpet_request_id)){{$payment->carpet_request_id}} @else N/A @endif</td>
                                ...
                                <td>
                                    <a href="{{url('admin/carpet-payment-detail/'.$payment->id)}}" class="btn btn-danger">View</a>
                                </td>
                        @endforeach
                        </tbody>
                    </table>
