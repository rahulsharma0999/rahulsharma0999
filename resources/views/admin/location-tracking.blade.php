                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="topBreadcrumb">                
                          <a class="breadcrumb-item" >Location Tracking</a><!-- href="{{url('admin/location-tracking')}}" -->
                    ...
                    <div class="content package-management">
                            <div class="signup-wrap login-wrap change-password van-location-ww">
                             <div class="van-dropdown">
                               ...
                               <select class="form-control" style="border:1px solid #ccc; max-width: 300px; width: 100%;     background-color: #fff;
">
