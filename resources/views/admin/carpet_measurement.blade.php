...
@section('title', 'Carpet Measurement')
@section('content')
<style type="text/css">
.d-flex {
        display: flex;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="topBreadcrumb">                
                          ...
                          <span class="breadcrumb-item active">Carpet Measurement</span>
                        </nav>
                    </div>
                </div>
            </div>
                           ...
                           <!-- <form action="{{url('admin/add-new-vehicle')}}" method="post"> -->
                            ...
                            <ul>   
                                ...
                                <div class="sign-up-right">
                                    <input type="text" maxlength="10" name="height"  placeholder="Length " autocomplete="off" >
                            ...
                            <ul>   
                                ...
                                <div class="sign-up-right">
                                    <input type="text" maxlength="10" name="width"  placeholder="Width " autocomplete="off" >
