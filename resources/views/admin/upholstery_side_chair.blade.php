...
@section('title', 'Upholstery Side Chairs')
@section('content')
<style type="text/css">
.d-flex {
        display: flex;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="topBreadcrumb">                
                          ...
                          <span class="breadcrumb-item active">Upholstery Side Chairs</span>
                        </nav>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="content package-management">
                            ...
                            <div class="create-service-ww">
                              <h1 class="main-heading">Add Upholstery Side Chairs</h1>
                            </div>
                           ...
                           <!-- <form action="{{url('admin/add-new-vehicle')}}" method="post"> -->
                            ...
                            <ul>   
                                ...
                                <div class="sign-up-right">
                                    <input type="text" maxlength="5" name="side_chair"  placeholder="Please enter side chair " autocomplete="off" >
            ...
            <div class="modal-content">
              <div class="modal-body">
                <p>Do  you really want to delete it?</p>
                    <form id="del" action="{{url('admin/delete-side-chair/'.'*')}}" method="post">
                        {{ csrf_field() }}
