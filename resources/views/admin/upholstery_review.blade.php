...
@section('title', 'Upholstery Review')
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="topBreadcrumb">                
                          ...
                          <span class="breadcrumb-item active">Upholstery Review</span>
                        </nav>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                           ...
                           @endphp
                              ...
                              <tr>
                                ...
                                <td>{{ $review->upholstery_request_id}}</td>
                                ...
                                <td>
                                <a href="{{url('admin/upholstery-review-detail/'.$review->id)}}" class="btn btn-danger">view</a>
