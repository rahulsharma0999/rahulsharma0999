                         ...
                         @foreach($data as $data) 
                              <tr>
                               <th>{{$i++}}</th>
                                ...
                                <td><a href="{{url('admin/request-new-upholstery-detail/'.$data->id)}}" class="btn btn-danger">view</a> 
                                 <a href="#blockPopup"  ui="{{$data->id}}"  data-toggle="modal" data-target="#blockPopup" class="btn btn-danger text del">delete</a>
            ...
            <div class="modal-content">
              <div class="modal-body">
                <p>Do  you really want to delete it?</p>
                    <form id="del" action="{{url('admin/delete-new-upholstery-request/'.'*')}}" method="post">
                        {{ csrf_field() }}
