...
@section('title', 'Upholstery Couches')
@section('content')
<style type="text/css">
.d-flex {
        display: flex;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <nav class="topBreadcrumb">                
                          ...
                          <span class="breadcrumb-item active">Upholstery Couches</span>
                        </nav>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="content package-management">
                            ...
                            <div class="create-service-ww">
                              <h1 class="main-heading">Add Upholstery Couches</h1>
                            </div>
                           ...
                           <!-- <form action="{{url('admin/add-new-vehicle')}}" method="post"> -->
                            ...
                            <ul>   
                                ...
                                <div class="sign-up-right">
                                    <input type="text" maxlength="5" name="couche"  placeholder="Please enter couches " autocomplete="off" >
            ...
            <div class="modal-content">
              <div class="modal-body">
                <p>Do  you really want to delete it?</p>
                    <form id="del" action="{{url('admin/delete-couches/'.'*')}}" method="post">
                        {{ csrf_field() }}
