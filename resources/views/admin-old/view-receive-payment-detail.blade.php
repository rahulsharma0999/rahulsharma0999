...
@section('title', 'Payment Receive Detail')
@section('heading')
                        ...
                        <div class="infomationSection">
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-9">
                                    <div class="infoContent">
                                        <p> Account Name <span class="pull-right">Dummy</span></p>
                                        <p> Account Number <span class="pull-right">11122-2454112</span></p>
                                        <p> BSB Number <span class="pull-right">21212</span></p>
                                    </div>
                                </div>
                            </div> 
                          ...
                          <div class="b-m-order-details">
                            <ul>
                              ...
                              <li>
                                ...
                                <div class="b-m-o-d-right">
                                  <p>Payment Successfully Transfered to photographer bank account</p>
                                </div>
                              </li>
                            </ul>
                          </div>
